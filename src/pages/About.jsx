  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center px-4 py-16">
      ...
      <div className="relative mt-16 w-full max-w-6xl">
        ...
        {/* Stats Box */}
        <div className="bg-gray-800/90 text-white shadow-2xl rounded-lg p-6 max-w-4xl mx-auto mt-8 md:absolute md:left-1/2 md:-bottom-14 md:-translate-x-1/2 md:mt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-300">Dishes in our menu</span>
            </div>
