    ...
    <div className="bg-black py-16 md:py-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-5 md:gap-10 px-4 md:px-0">
        ...
        <div ref={textRef} className="flex-[3] flex flex-col gap-4 md:gap-6">
          ...
          <Link 
            to="/about"
            className="inline-block mt-4 px-6 py-2.5 bg-yellow-500 text-black font-semibold rounded-full shadow-lg hover:bg-yellow-400 transition transform hover:-translate-y-1 text-center"
          >
            Read More
          </Link>
        </div>
